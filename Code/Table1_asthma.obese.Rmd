...
listVar.gold<- c( 'age_v1_v2',"gender_v1_v2", 'background_5',  'relocation_age', 'generation2','education_v1_v2','income_v1_v2', 
                  'AHEI2010',
                  'bmi_v1_v2', 'bmi_cat_v1_v2',"smoker.current.v1.v2","asthma.current.obese", "asthma.child.onset12" , 'prs.std.wang')
...
labels.gold<- c( 'Current asthma','Age',"Sex", 'National background', 'Immigration age',
                 'Generation','Education','Income','Alternate Healthy Eating Index', 'BMI',
