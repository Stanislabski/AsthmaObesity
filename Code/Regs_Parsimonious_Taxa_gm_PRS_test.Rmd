...
Ethan thinks the most basic model starts with age, sex, PCs.  We are also interested in what genetics adds to GM data, so we will do it both ways.
...
m1.otu<- 'score.all'
covs.m1<- c('male','AGE_GOLD','income','education', 'relocation_age', 'other', 'Dominican', 'Cuban', 'PuertoRican', 'generation','smoker.current.v1.v2', 'AHEI2010','PC1', 'PC2','PC3','PC4','PC5')
...
Set 3: gender_v1_v2 ,AGE_GOLD,  income,education_v1_v2, relocation_age, background, generation , smoking  , HEI
